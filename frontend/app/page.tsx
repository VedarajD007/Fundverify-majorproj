      ...
      if (typeof window !== 'undefined') {
        ...
        if (window.ethereum) {
          ...
          const installMetaMask = confirm(
            ...
            "Click OK to install MetaMask, or Cancel to continue without wallet connection.\n\n" +
        ...
        alert("Please use a browser that supports Web3 (like Chrome, Firefox, or Brave)");
        return;
      }
