...
### 1. Clone and Setup
```bash
git clone https://github.com/18vikastg/Public-Fund-Management.git
cd Public-Fund-Management
```
...
- **Etherscan API Key**: https://etherscan.io/apis (optional)

### 6. Access Application
- Frontend: http://localhost:3000
- Backend API: http://localhost:8000

For detailed setup instructions, see individual README files in each directory.# ProjectFund
# projectfund
